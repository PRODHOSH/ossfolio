...
export const metadata: Metadata = {
  ...
  description:
    'Learn how to embed OSSfolio contribution widgets, heatmaps, and SVG badges in your GitHub README, blog, or portfolio.',
};
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        >
          Showcase your open-source contributor score, merged PRs, and
          contribution heatmap anywhere across the web: in your GitHub profile
          README, personal portfolio, Notion documents, or blog posts.
        </p>
        ...
        >
          ...
          <p
            style={{ fontSize: '14px', color: '#cbd5e1', marginBottom: '16px' }}
          >
            Embed lightweight, auto-updating SVG badges directly into your
            Markdown files or GitHub profile README.
          </p>
        ...
        >
          ...
          <p
            style={{ fontSize: '14px', color: '#cbd5e1', marginBottom: '16px' }}
          >
            Embed an interactive contribution card with stats and mini activity
            graph on your website or blog.
          </p>
...
></iframe>`}</code>
        ...
        >
          ...
          <p
            style={{ fontSize: '14px', color: '#cbd5e1', marginBottom: '16px' }}
          >
            Export raw contribution statistics and pull request details
            programmatically:
          </p>
          ...
          <ul style={{ fontSize: '14px', color: '#a5b4fc', lineHeight: 1.8 }}>
            <li>
              ...
              <code>GET /api/export/YOUR_USERNAME?format=json</code>
            </li>
            <li>
              <strong>CSV Format:</strong>{' '}
              <code>GET /api/export/YOUR_USERNAME?format=csv</code>
            </li>
          </ul>
        </section>
      </div>
