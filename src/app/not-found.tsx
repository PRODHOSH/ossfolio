      ...
      <div style={{ textAlign: "center", maxWidth: "28rem" }}>
        ...
        >
          ...
          >
            ...
            {/* Visor */}
            <ellipse cx="90" cy="72" rx="14" ry="13" fill="#3ecf8e" opacity="0.85" />
            {/* Visor glare */}
            ...
            <path
              ...
              stroke="#e5e7eb" strokeWidth="14" strokeLinecap="round" fill="none"
            />
            {/* Left glove */}
            ...
            <path
              ...
              stroke="#e5e7eb" strokeWidth="13" strokeLinecap="round" fill="none"
            />
            ...
            {/* Helmet outline ring */}
            <circle cx="90" cy="72" r="22" stroke="#d1d5db" strokeWidth="2" fill="none" />
          </svg>
        </div>
