      ...
      >
        ...
        >
          ...
          <header style={{ marginBottom: '32px' }}>
            ...
            >
              Your contributor score is a single number that sums up your
              open-source activity. It is built from public GitHub data using
              the simple, fixed formula below - no hidden weighting, no manual
              adjustments.
            </p>
          </header>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={paragraphStyle}>
              ...
              the sum of all of them, rounded to the nearest whole number.
            </p>
            <div
              style={{
            ...
            >
              ...
              works out to 40 + 30 + 12 + 8 + 30 = 120 points.
            </p>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <p style={paragraphStyle}>
              ...
              requests and issues counts for more than raw commits because they
              usually represent more complete units of work, and reviews count
              because helping other people ship is real contribution too. Stars
              add a small amount so that widely-used work is recognised, but
              they are capped so a single popular repo cannot dominate your
              number.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            <p style={paragraphStyle}>
              ...
              any single contribution was. A large refactor and a one-line fix
              both count as one commit. Private contributions are not included,
              because the score is built only from public GitHub activity. Think
              of it as a rough signal of activity over time, not a ranking of
              skill.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '40px' }}>
            ...
            <p style={paragraphStyle}>
              ...
              the project grows the weights may be tuned, and signals like
              review depth or recency could be added so the score better
              reflects sustained contribution. Any change to how scores are
              calculated will be reflected on this page.
            </p>
          </section>
