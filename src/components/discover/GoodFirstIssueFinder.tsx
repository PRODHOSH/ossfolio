    ...
    <div style={{ marginTop: "24px" }}>
      ...
      >
        <div>
          ...
          >
            Beginner-friendly open-source issues labeled <code style={{ color: "var(--color-primary)" }}>good first issue</code> or <code style={{ color: "var(--color-primary)" }}>help wanted</code>.
          </p>
        </div>
