  ...
  return (
    ...
    >
      <div>
        ...
        >
          Adjust the sliders below to see how each contribution type contributes
          to the overall profile score.
        </p>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div>
            ...
            >
              <span>
                Stars ({SCORE_WEIGHTS.STAR} pts each, capped at {STAR_CAP})
              </span>
        ...
        >
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 500 }}>
                  +{breakdown.commitsContribution} pts
                </span>
              </li>
              <li
                style={{
              ...
              >
                ...
                <span style={{ fontWeight: 500 }}>
                  +{breakdown.issuesContribution} pts
                </span>
              </li>
              <li
                style={{
              ...
              >
                ...
                <span style={{ fontWeight: 500 }}>
                  +{breakdown.reviewsContribution} pts
                </span>
              </li>
              <li
                style={{
              ...
              >
                <span style={{ color: 'var(--color-ink-mute)' }}>
                  Stars Contribution {stars > STAR_CAP && '(capped)'}
                </span>
                <span style={{ fontWeight: 500 }}>
                  +{breakdown.starsContribution.toFixed(1)} pts
                </span>
              </li>
            </ul>
          </div>
          ...
          >
            ...
            >
              ...
              <span
                style={{ fontSize: '36px', fontWeight: 700, color: '#3ecf8e' }}
              >
                {breakdown.total}
              </span>
            </div>
