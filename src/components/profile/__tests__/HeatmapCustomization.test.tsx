...
describe("Heatmap Color Theme Engine", () => {
  it("computes correct shades for counts across different color themes", () => {
    expect(getShadeForCount(0, "emerald")).toBe(HEATMAP_THEMES.emerald.shades[0]);
    expect(getShadeForCount(2, "emerald")).toBe(HEATMAP_THEMES.emerald.shades[1]);
    expect(getShadeForCount(10, "emerald")).toBe(HEATMAP_THEMES.emerald.shades[4]);
    ...
    expect(getShadeForCount(10, "violet")).toBe(HEATMAP_THEMES.violet.shades[4]);
  });
});
