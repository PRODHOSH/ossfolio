  ...
  'inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-semibold shadow-xs transition-colors border',
  {
    variants: {
      tier: {
        ...
        gold: 'text-[#ffd700] bg-[rgba(255,215,0,0.15)] border-[#ffd700] dark:bg-[rgba(255,215,0,0.22)] uppercase tracking-wider text-[11px] font-bold rounded-sm px-2 py-0.5',
        platinum:
      ...
      program: {
        ...
        gssoc:
          'bg-gradient-to-r from-[#FF9900] to-[#FF5E36] text-white border-transparent shadow-xs',
        hacktoberfest:
          'bg-gradient-to-r from-[#FF2201] to-[#FF007A] text-white border-transparent shadow-xs',
        elusoc:
          'bg-gradient-to-r from-[#6b01c2] to-[#00d2ff] text-white border-transparent shadow-xs',
        swoc: 'bg-gradient-to-r from-[#644fc1] to-[#c7007e] text-white border-transparent shadow-xs',
        default:
          'bg-gradient-to-r from-[#707070] to-[#9a9a9a] text-white border-transparent shadow-xs',
        none: '',
      },
      size: {
...
function ContributorBadge({
  ...
  return (
    <div
      className={cn(
        contributorBadgeVariants({ tier, program, size }),
        className,
      )}
      {...props}
    />
