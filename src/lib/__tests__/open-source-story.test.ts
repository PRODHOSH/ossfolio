...
import {
  generateOpenSourceStory,
  getTopLanguage,
} from "../open-source-story";
...
describe("open-source-story generator", () => {
  ...
  it("generates markdown story with user stats and score", () => {
    const story = generateOpenSourceStory("octocat", mockStats, mockRepos, 850, 2026);
    ...
    expect(story.markdown).toContain("# 🚀 My 2026 Open Source Story — @octocat");
