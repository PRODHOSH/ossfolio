...
describe("org-stats aggregation module", () => {
  ...
  it("aggregates PRs and issues by organization login", () => {
    ...
    const prs: PRImpactDetails[] = [
      { repositoryName: "facebook/react", prNumber: 101, title: "Fix hook bug", stars: 100 },
      { repositoryName: "facebook/react", prNumber: 102, title: "Add feature", stars: 100 },
      { repositoryName: "vercel/next.js", prNumber: 201, title: "Update SSR", stars: 50 },
    ];

    const issues: IssueImpactDetails[] = [
      { repositoryName: "facebook/react", issueNumber: 55, title: "Memory leak", stars: 100 },
    ];
