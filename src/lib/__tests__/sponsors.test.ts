...
describe("sponsors module", () => {
  describe("sanitizeFundingLinks", () => {
    it("should validate and clean funding link inputs", () => {
      const raw = [
        { platform: "GitHub Sponsors", url: "https://github.com/sponsors/testuser" },
  ...
  describe("Sponsored Creator Achievement", () => {
    it("should unlock Sponsored Creator achievement when hasFunding is true", () => {
      const achievements = evaluateAchievements({
        stats: { totalCommits: 10, totalPRs: 5, totalIssues: 2, totalReviews: 1, totalContributions: 18 },
        longestStreak: 5,
        hasFunding: true,
      });

      const sponsoredAchievement = achievements.find((a) => a.id === "sponsored_creator");
